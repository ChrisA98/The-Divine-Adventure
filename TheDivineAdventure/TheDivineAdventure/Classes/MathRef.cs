...
namespace TheDivineAdventure
{
    ...
    class MathRef {
        ...
        static public float Calculate2DAngleFromZero(float x, float y) {
        ...
        {
            while (angle > MathRef.RADIANS_360) angle -= MathRef.RADIANS_360;
            while (angle < 0) angle += MathRef.RADIANS_360;
            return angle;
        }
    }
