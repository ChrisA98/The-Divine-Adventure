...
namespace TheDivineAdventure.SkinModels.SkinModelHelpers
{
    public class LoadDebugInfo
    {
        ...
        // ASSIMP SCENE DUMP 
        public void AssimpSceneDump(Assimp.Scene scene)
        {
        ...
        public void InfoForMeshMaterials(SkinModel model, Assimp.Scene scene)
        {
        ...
        // SHOW NODE TREE INFO
        public void ShowNodeTreeInfo(int tabLevel, Node curAssimpNode, bool matrixInfo, SkinModel.ModelNode modelNode, SkinModel model, Assimp.Scene scene)
        {
            string ntab = "";
            for (int i = 0; i < tabLevel; i++) ntab += "  ";
            string ntab2 = ntab + "    ";
